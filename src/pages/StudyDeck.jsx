    ...
    <div className="space-y-8 animate-fadeIn">
      <div id="deck-header" className="flex justify-between items-end border-b border-border pb-6">
        ...
        <div className="flex gap-3">
            {/* CLEAR DECK BUTTON */}
            {cards.length > 0 && (
                <button onClick={clearDeck} className="pro-btn bg-red-500/10 hover:bg-red-500/20 text-red-500 border border-red-500/20 flex items-center gap-2">
                    <Trash2 size={18} /> Clear Deck
                </button>
            )}
