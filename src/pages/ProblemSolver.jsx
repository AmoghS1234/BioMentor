...
import { Code, Play, Terminal, Sparkles, Loader, CheckCircle, XCircle, Eye, EyeOff, Trophy } from 'lucide-react';
...
export default function ProblemSolver() {
  ...
  return (
    // MAIN CONTAINER: Fixed height calculation ensures it fits exactly under a standard navbar
    <div className="h-[calc(100vh-120px)] flex flex-col animate-fadeIn w-full max-w-7xl mx-auto">
      ...
      {/* WORKSPACE LAYOUT: Sidebar (Fixed) + Main (Flex-Grow) */}
      <div className="flex-1 flex flex-col md:flex-row gap-6 min-h-0">
            ...
            {challenges.map(c => {
              ...
              return (
                <button 
                  ...
                  className={`w-full text-left p-3 rounded-lg text-sm flex justify-between items-center transition-all border ${
                    activeId === c.id 
        ...
        <div className="flex-1 flex flex-col gap-4 min-h-0">
          ...
          {/* BOTTOM PANEL: TERMINAL (Fills remaining space) */}
