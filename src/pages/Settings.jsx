...
export default function Settings() {
  ...
  const { clearAccountData } = useFirebase();
  ...
  const handleWipe = async () => {
    ...
    // No need to reset state, page will reload
  };
        ...
        <div className="pro-panel p-6 border-red-500/20 bg-red-500/5 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-txt-secondary text-sm">
                        Permanently delete all notes, chats, flashcards, protocols, and XP. <br/>
            ...
            <div className="bg-panel border border-red-500/30 rounded-2xl shadow-2xl w-full max-w-md relative overflow-hidden">
                <div className="p-6 text-center">
                    ...
                    <p className="text-txt-secondary text-sm leading-relaxed mb-6">
                        This action will <span className="font-bold text-red-400">permanently delete</span> all your research notes, chat history, flashcards, custom protocols, and quiz progress. 
