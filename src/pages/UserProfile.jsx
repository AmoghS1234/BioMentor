  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fadeIn">
      ...
      <div className="pro-panel p-8 bg-gradient-to-r from-brand/20 to-transparent border-brand/20 flex items-center gap-6">
        ...
        <div>
            {/* 👇 UPDATED: Shows Display Name OR Email. Only shows 'Guest' if both are missing. */}
            <h1 className="text-3xl font-bold text-txt-primary">
              {user.displayName || user.email || 'Guest Researcher'}
            </h1>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 p-3 rounded-lg bg-page/50 border border-border">
                        ...
                        <div>
                            ...
                            <p className="text-txt-primary">{profile?.lastLogin ? new Date(profile.lastLogin).toLocaleDateString() : 'Just now'}</p>
                        </div>
                    </div>
                </div>
            </div>
